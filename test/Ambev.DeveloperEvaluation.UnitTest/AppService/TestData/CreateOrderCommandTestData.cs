...
{
    public static class CreateOrderCommandTestData
    {
        private static readonly Faker<CreateOrderCommand> faker = new Faker<CreateOrderCommand>()
            ...
            .RuleFor(c => c.Items, f => new Faker<CreateOrderItemCommand>()
        ...
        public static CreateOrderCommand Generate()
        {
            return faker.Generate();
        }

        public static List<CreateOrderCommand> Generate(int count)
        {
